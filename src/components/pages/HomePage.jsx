...
function Home(props){
  ...
  return (
    <div>
      <Hero backgroundImage="./assets/images/bootstrap-themes.png">
        <div className="container col-xxl-8 px-4 py-5 homepage">
          <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div className="col-10 col-sm-8 col-lg-6">
              <img src="./assets/images/avatar.png" className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy" />
            </div>
            <div className="col-lg-6">
              ...
              <div className="d-grid gap-2 d-md-flex justify-content-md-center">
                <a href='./assets/fake-cv.pdf' download type="button" className="btn btn-primary btn-lg px-4 me-md-2" target="_blank">Download resume </a>
